...
function codeValidate() {
  ...
  function editCoupon(event) {
    ...
    fetch("/admin/edit-coupon", {
      ...
      body: JSON.stringify({ code, startDate, endDate, discountPercentage, minOrderValue, maxDiscount, description, usageLimit,id })
    })
    ...
    .then((response) => {
      if (response.success) {
        Swal.fire({
          icon: "success",
          title: "Coupon Successfully Edit",
